...
const checkboxStyles = tv({
  ...
  variants: {
    isDisabled: {
      false: "text-gray-800 dark:text-slate-200",
...
const boxStyles = tv({
  ...
  variants: {
    isSelected: {
      false:
        "bg-white dark:bg-slate-900 border-(--color) [--color:var(--color-gray-400)] dark:[--color:colors.slate-400)] group-pressed:[--color:var(--color-gray-500)] dark:group-pressed:[--color:var(--color-slate-300)]",
    ...
    isDisabled: {
      true: "[--color:var(--color-gray-200)] dark:[--color:var(--color-slate-700)] forced-colors:[--color:GrayText]!",
    },
  },
});
